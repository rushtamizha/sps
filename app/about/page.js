...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800 pt-32 pb-20 px-4 md:px-8 lg:px-16 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          ...
          <div className="lg:col-span-6 relative flex justify-center">
            ...
            <div className="w-full h-80 md:h-[400px] rounded-[2rem] overflow-hidden bg-gray-200 border border-white shadow-xs relative">
              <img 
        ...
        {/* METRICS COUNT Grid */}
        <div className="bg-gray-900 text-white rounded-[2.5rem] p-8 md:p-12 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center shadow-xs mb-24 relative overflow-hidden">
        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {CORE_VALUES.map((val, idx) => {
              const Icon = val.icon;
              return (
                <div key={idx} className="bg-white border border-gray-100 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col sm:flex-row gap-5 items-start hover:shadow-md transition-shadow">
        ...
        {/* CALL TO ACTION LAYOUT INTERACTION FRAME */}
        <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8 md:p-12 shadow-xs text-center max-w-5xl mx-auto relative overflow-hidden">
          <div className="absolute -top-12 -left-12 w-40 h-40 bg-blue-50 rounded-full blur-3xl opacity-60 pointer-events-none" />
          <h3 className="text-2xl md:text-4xl font-semibold  text-gray-900">
            Ready to Experience Premium Logistics?
          </h3>
          <p className="text-gray-500 text-xs md:text-sm max-w-xl mx-auto mt-3 mb-8 font-medium">
            Book your certified one-way ride or daily package with our support desk today. We offer clear answers to fare questions with zero reservation fees.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="tel:+916369424744"
              className="flex items-center justify-center gap-2.5 bg-gray-900 hover:bg-gray-800 text-white font-bold py-3.5 px-6 rounded-xl text-xs uppercase  transition-colors w-full sm:w-auto shadow-md"
            >
