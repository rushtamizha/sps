      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 space-y-3">
          ...
          <h1 className="text-2xl md:text-4xl font-semibold text-gray-900  leading-tight">
            ...
            <span className="text-emerald-600">Intercity Travel</span> Experience
          </h1>
          <p className="text-gray-500 text-sm md:text-base font-medium max-w-2xl mx-auto">
            Green Tours & Travels was established with a singular objective: to eliminate hidden costs and deliver dependable transit across South India.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-10">
          <div className="lg:col-span-6 space-y-5">
            ...
            <p className="text-gray-600 text-sm md:text-base leading-relaxed">
              For years, outstation travelers faced ambiguous pricing setups, dynamic surging, and poor vehicle upkeep. Green Tours & Travels entered the market to reshape this landscape by introducing certified one-way premium fares and structured round-trip solutions.
            </p>
            <p className="text-gray-600 text-sm md:text-base leading-relaxed">
          ...
          <div className="lg:col-span-6 relative flex justify-center">
            <div className="absolute inset-0 bg-gradient-to-tr from-emerald-100 to-transparent rounded-[2.5rem] transform -rotate-3 scale-102 -z-10" />
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-gray-100 flex items-center justify-between">
                <div>
                  ...
                  <span className="text-sm font-extrabold text-gray-900 flex items-center gap-1">
                    <MapPin className="w-4 h-4 text-emerald-600" /> Tamil Nadu & South India
                  </span>
                </div>
                <Users className="w-8 h-8 text-emerald-600 opacity-20" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 text-white rounded-[2.5rem] p-8 md:p-12 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center shadow-xs mb-10 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-900/20 via-transparent to-transparent pointer-events-none" />
          {STATS.map((stat, i) => (
            <div key={i} className="space-y-1">
              <div className="text-3xl md:text-5xl font-semibold text-emerald-500 ">{stat.metric}</div>
