...
export default function Testimonials() {
  return (
    <section className="w-full bg-white py-10 px-4 md:px-8 lg:px-16 text-gray-800 relative overflow-hidden">
      ...
      <div className="absolute bottom-10 -left-20 w-72 h-72 bg-blue-50/40 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-blue-700 font-bold text-xs uppercase tracking-widest bg-blue-50 px-3.5 py-1.5 rounded-full w-max">
             <MessageCircle className="w-3.5 h-3.5" />
              Makkal Feedback
            </div>
            <h2 className="text-2xl md:text-4xl font-semibold text-gray-900 tracking-tight ">
              Trusted By Thousands <br />
              <span className="text-blue-700">Of Tamilnadu Travelers</span>
            </h2>
                ...
                <div className="bg-gray-50/60 border border-gray-100 rounded-[2rem] p-6 md:p-8 flex flex-col h-full justify-between transition-all duration-300 hover:bg-white hover:shadow-sm hover:border-white m-0.5 relative group">
                  ...
                  <div className="pt-5 mt-6 border-t border-gray-100 flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-600 to-green-700 text-white font-extrabold flex items-center justify-center text-sm shadow-md shrink-0">
                        {review.name.charAt(0)}
                      </div>
                      <div className="min-w-0">
                        <h4 className="text-sm font-black text-gray-900 truncate tracking-tight flex items-center gap-1">
                          {review.name}
                          <span className="material-symbols-outlined text-green-500 text-base font-bold" style={{ fontVariationSettings: '"FILL" 1' }}>
                            verified_user
                          </span>
                        </h4>
