...
const Navbar = () => {
        ...
        >
          ...
          <div className="flex flex-col justify-center leading-tight">
            <p className="text-md font-bold  uppercase text-gray-900">
              Ganapathy
              <span className="ml-1 text-blue-700">Travels</span>
            </p>
            <p className="text-xs font-medium  text-blue-700/70  tracking-wide">
  ...
  <div
    ...
    className="relative px-3 py-2 transition-all rounded-full cursor-pointer group hover:bg-blue-700/5"
  ...
  >
    <Link href={menu.link || "#"}>
      <span className="flex items-center gap-2 text-sm font-semibold text-gray-700 group-hover:text-blue-700">
        ...
        <span className="hidden transition-colors opacity-70 group-hover:block group-hover:text-blue-700">
          {menu.icon}
        </span>
        {menu.name}
        {menu.items}
        ...
        <div className="items-center hidden gap-3 rounded-full lg:flex">
          <button
            ...
            className="flex items-center gap-2 py-3 text-xs font-bold  text-white trcaking-wide uppercase transition-all rounded-full shadow-md bg-blue-700 px-7 hover:bg-blue-700"
          >
            ...
            <div className="flex flex-col gap-5">
              {navData.map((menu, idx) => (
                <div key={idx} className=" border-gray-50  pb- last:pb-0">
                  <Link 
                    ...
                    className="flex items-center gap-3 py-2 text-sm font-semibold text-gray-700 hover:text-blue-700 transition-colors group"
                  >
                    <span className="text-gray-400 group-hover:text-blue-700 group">{menu.icon}</span>
                    <span>{menu.name}</span>
                  </Link>
                </div>
              ))}
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full bg-blue-700 hover:bg-blue-700 text-white py-3.5 rounded-full text-sm font-bold flex items-center justify-center gap-2 shadow-lg  transition-colors"
                >
